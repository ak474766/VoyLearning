    ...
    extend: {
      ...
      keyframes: {
        ...
        glow: {
          ...
          '100%': { boxShadow: '0 0 0 rgba(124,58,237,0)' },
        },
        'rotate-slow': {
      ...
      boxShadow: {
        ...
        'premium-md': '0 8px 30px rgba(0,0,0,0.08)',
        'premium-lg': '0 16px 40px rgba(0,0,0,0.12)',
        'premium-xl': '0 28px 60px rgba(0,0,0,0.18)',
