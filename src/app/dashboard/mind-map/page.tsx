                ...
                <nav className="hidden md:flex items-center gap-1">
                  {['Notes', 'Mind Map', 'Quizzes'].map((item) => (
                    <Link
                      ...
                      className={`px-4 py-2 rounded-lg text-sm font-medium transition-all ${item === 'Mind Map'
        ...
        <main className="relative z-10 pt-28 pb-12 px-4 sm:px-6 lg:px-8 mx-auto max-w-7xl">
              ...
              <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
                <div className="max-w-2xl z-20">
                  <h1 className="text-4xl md:text-6xl font-bold mb-6 tracking-tight drop-shadow-lg">
                    Mind <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-300 via-pink-300 to-blue-300 animate-gradient-x">Map</span>
                  </h1>
                  <p className="text-lg text-gray-200 mb-8 leading-relaxed max-w-lg">
                    Visualize your learning path and connect concepts. This feature is currently under construction.
                  </p>
                </div>
          ...
          <section className="flex flex-col items-center justify-center py-20 text-center">
            ...
            <p className="text-gray-400 max-w-md mx-auto">
              We are building a powerful mind mapping tool for you. Check back later!
            </p>
          </section>
        </main>
      </div>
