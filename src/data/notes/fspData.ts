...
// Foundations of Systems and Programming (FSP)
// Mapped from /public/notes/fsp
export const fspNotesData: NoteData[] = [
  ...
  },
  {
    ...
    week: 2,
    lesson: 0,
    tags: ['Descriptive Stats', 'Mean/Median/Mode'],
