...
export function LampContainer({
  ...
  return (
    <div
      className={cn(
        'relative flex min-h-[18rem] w-full flex-col items-center justify-center overflow-hidden bg-transparent rounded-md z-0',
        className
      )}
      aria-hidden
    >
      ...
      {children ? (
        <div className="relative z-50 -translate-y-40 flex flex-col items-center px-5">
          {children}
        </div>
      ) : null}
    </div>
